...
| `quality-remediation` | 完成（本地范围） | AppSec 10/10、skills、stack-run、verify-evidence、QR-10 focused regression 与总复核通过；Firefox lint 为 0 error / 0 notice / 28 条非阻断 warning |
